...
extern void *mono_aot_module_Xamarin_iOS_BAC__info;
...
{
	mono_aot_register_module (mono_aot_module_Xamarin_iOS_BAC__info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Xamarin.iOS_BAC_.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
